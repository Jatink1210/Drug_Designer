...
export default function ConfidenceBar({ value, label, reasoning }: ConfidenceBarProps) {
    ...
    return (
        <div className="group relative inline-flex items-center gap-2 min-w-[100px]">
            ...
            <span className="text-[10px] font-medium w-12 text-right" style={{ color }}>{pct}% <span className="text-[8px] opacity-70">{semantic}</span></span>
            {(reasoning || label) && (
