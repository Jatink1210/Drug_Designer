...
export default function ContradictionBanner({ contradiction }: { contradiction: ContradictionDTO }) {
    const [expanded, setExpanded] = useState(false);
    const style = SEVERITY_STYLES[contradiction.severity] || SEVERITY_STYLES.moderate;
    ...
    return (
        ...
        >
            ...
            >
                ...
                <span className="text-[11px] font-medium flex-1" style={{ color: style.text }}>
                ...
                <div className="px-3 pb-3 space-y-2">
                    <div className="grid grid-cols-[1fr_auto_1fr] gap-2 items-start">
                        ...
                        <div className="flex items-center px-1">
                            <span className="text-[10px] font-bold" style={{ color: style.text }}>vs</span>
                        </div>
                        {/* Claim B */}
                        <div className="rounded p-2 bg-white/70">
                            <p className="text-[10px] text-[var(--text-secondary)] leading-relaxed line-clamp-3">
